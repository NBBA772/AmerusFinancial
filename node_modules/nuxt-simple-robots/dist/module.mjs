...
import { useNuxt, createResolver, addTemplate, loadNuxtModuleInstance, hasNuxtModule, getNuxtModuleVersion, hasNuxtModuleCompatibility, defineNuxtModule, useLogger, addPlugin, addImports, addComponent, addServerHandler, addServerPlugin } from '@nuxt/kit';
...
function setupDevToolsUI(options, resolve, nuxt = useNuxt()) {
  ...
  onDevToolsInitialized(async () => {
    extendServerRpc("nuxt-simple-robots", {});
  });
