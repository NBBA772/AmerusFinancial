 ...
 */
declare function parseBodyAs<ZodSchema extends z.ZodTypeAny>(event: H3Event, schema: ZodSchema, errorCode?: number, errorMessage?: string): Promise<z.TypeOf<ZodSchema>>;
/**
 ...
 * @param {string} [errorMessage="Data parsing failed"] - Optional error message if parsing fails
 */
declare function parseParamsAs<ZodSchema extends z.ZodTypeAny>(event: H3Event, schema: ZodSchema, errorCode?: number, errorMessage?: string): z.TypeOf<ZodSchema>;
/**
 ...
 * @param {string} [errorMessage="Data parsing failed"] - Optional error message if parsing fails
 */
declare function parseQueryAs<ZodSchema extends z.ZodTypeAny>(event: H3Event, schema: ZodSchema, errorCode?: number, errorMessage?: string): z.TypeOf<ZodSchema>;
/**
 ...
 * @param {string} [errorMessage="Data parsing failed"] - Optional error message if parsing fails
 */
declare function parseCookieAs<ZodSchema extends z.ZodTypeAny>(event: H3Event, schema: ZodSchema, errorCode?: number, errorMessage?: string): z.TypeOf<ZodSchema>;
/**
 ...
 * @param {string} [errorMessage="Data parsing failed"] - Optional error message if parsing fails
 */
declare function parseHeaderAs<ZodSchema extends z.ZodTypeAny>(event: H3Event, schema: ZodSchema, errorCode?: number, errorMessage?: string): z.TypeOf<ZodSchema>;
/**
 ...
 * @param {string} [errorMessage="Data parsing failed"] - Optional error message if parsing fails
 */
declare function parseDataAs<ZodSchema extends z.ZodTypeAny>(dataOrPromise: any | Promise<any>, schema: ZodSchema, errorCode?: number, errorMessage?: string): Promise<z.TypeOf<ZodSchema>>;
/**
 ...
 * ```
 */
declare function makeParser<ZodSchema extends z.ZodTypeAny>(schema: ZodSchema, errorCode?: number, errorMessage?: string): (data: any, errorCodeOverwrite?: undefined, errorMessageOverwrite?: undefined) => z.TypeOf<ZodSchema>;
/**
 * Make a data transformer based on a schema. All data passed into it will be turned into data of that schema (or the transformer will throw during parsing)
 * This method will throw an exception (like 422 Unprocessible Entity) if data validation fails. The error code and message can be customized.
 * @param {z.ZodTypeAny} schema - message to return to client if parsing and validating `D` fails
 ...
 * ```
 */
declare function makePromiseParser<ZodSchema extends z.ZodTypeAny>(schema: ZodSchema, errorCode?: number, errorMessage?: string): (promise: Promise<any>, errorCodeOverwrite?: undefined, errorMessageOverwrite?: undefined) => Promise<z.TypeOf<ZodSchema>>;

export { makeParser, makePromiseParser, parseBodyAs, parseCookieAs, parseDataAs, parseHeaderAs, parseParamsAs, parseQueryAs };
