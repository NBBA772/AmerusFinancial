  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        ...
        { property: "og:url", content: "https://www.amerusfinancial.com/services/business/commercial-auto" },
    ...
    useHead({
      link: [
        {
          rel: "canonical",
          href: "https://www.amerusfinancial.com/services/business/commercial-auto"
        },
    ...
    const benefits = [
      ...
      "Collision and comprehensive vehicle protection",
      "Coverage for owned, hired, and non-owned vehicles",
      "Medical payments and personal injury protection",
      "Uninsured and underinsured motorist coverage",
      "Fleet discounts and customizable coverage options"
    ];
    const info = [
      {
        title: "Coverage Amount",
        text: "Based on vehicle value and usage",
      ...
      },
      {
        ...
        text: "Fleet assessment and quote",
        icon: "lucide:clock"
      }
    ];
    const features = [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/business/commercial-auto.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=commercial-auto-DPrIasjh.mjs.map
