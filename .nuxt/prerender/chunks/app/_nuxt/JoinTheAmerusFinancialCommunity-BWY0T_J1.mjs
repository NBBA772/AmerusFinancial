...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="px-4 mb-8 md:block"><form><div class="grid grid-cols-1 md:grid-cols-2 gap-6"><div class="relative mb-6 group"><label for="floating_first_name" class="block mb-1 text-sm font-medium text-gray-100 text-left">First Name:</label><input type="text"${ssrRenderAttr("value", $data.firstName)} id="floating_first_name" name="floating_first_name" class="block w-full py-2.5 px-4 text-sm text-gray-100 bg-gray-100 border-b-2 border-gray-300 focus:outline-none focus:border-blue-500" placeholder=" " required></div><div class="relative mb-6 group"><label for="floating_last_name" class="block mb-1 text-sm font-medium text-gray-100 text-left">Last Name:</label><input type="text"${ssrRenderAttr("value", $data.lastName)} id="floating_last_name" name="floating_last_name" class="block w-full py-2.5 px-4 text-sm text-gray-100 bg-gray-100 border-b-2 border-gray-300 focus:outline-none focus:border-blue-500" placeholder=" " required></div></div><div class="relative mb-6 group"><label for="email" class="block mb-1 text-sm font-medium text-gray-100 text-left">Email:</label><input type="email"${ssrRenderAttr("value", $data.email)} id="email" name="email" class="block w-full py-2.5 px-4 text-sm text-gray-100 bg-gray-100 border-b-2 border-gray-300 focus:outline-none focus:border-blue-500" placeholder=" " required></div><div class="relative mb-6 group"><label for="phoneNumber" class="block mb-1 text-sm font-medium text-gray-100 text-left">Phone Number:</label><input type="tel"${ssrRenderAttr("value", $data.phoneNumber)} id="phoneNumber" name="phoneNumber" class="block w-full py-2.5 px-4 text-sm text-gray-100 bg-gray-100 border-b-2 border-gray-300 focus:outline-none focus:border-blue-500" placeholder=" " required></div><button type="submit" class="block w-full py-2.5 px-5 text-sm text-white bg-indigo-600 hover:bg-indigo-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> Request Quote </button></form></div></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/forms/JoinTheAmerusFinancialCommunity.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const JoinTheAmerusFinancialCommunity = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { JoinTheAmerusFinancialCommunity as default };
//# sourceMappingURL=JoinTheAmerusFinancialCommunity-BWY0T_J1.mjs.map
