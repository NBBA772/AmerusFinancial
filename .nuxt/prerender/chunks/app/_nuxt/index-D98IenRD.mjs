...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Auto Insurance Coverage & Protection \u2014 Amerus Financial",
      meta: [
        { property: "og:title", content: "Auto Insurance Coverage \u2014 Amerus" },
        { name: "description", content: "Comprehensive auto insurance with liability, collision, comprehensive, and specialized coverage options. Get competitive rates and protect your vehicle with Amerus." },
        { property: "og:description", content: "Auto insurance coverage including liability, collision, comprehensive, uninsured motorist, and specialized protection for your vehicle." },
        { property: "og:image", content: "https://www.amerusfinancial.com/images/auto-insurance-coverage.jpg" },
        { property: "og:url", content: "https://www.amerusfinancial.com/services/auto" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: "Auto Insurance Coverage \u2014 Amerus" },
        { name: "twitter:description", content: "Auto insurance coverage including liability, collision, comprehensive, uninsured motorist, and specialized protection for your vehicle." },
        { name: "twitter:image", content: "https://www.amerusfinancial.com/images/auto-insurance-coverage.jpg" },
        { name: "keywords", content: "auto insurance, car insurance, vehicle insurance, liability coverage, collision coverage, comprehensive coverage, auto insurance quotes, vehicle protection, auto insurance rates" }
      ]
    });
    useHead({
      link: [
    ...
    const hero = {
      ...
      image: "/images/auto-insurance-coverage.jpg",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/auto/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-D98IenRD.mjs.map
