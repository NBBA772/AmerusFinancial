...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/AnnuitiesPage/VariableAnnuitySection.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VariableAnnuitySection = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { VariableAnnuitySection as default };
//# sourceMappingURL=VariableAnnuitySection-COuoUgBs.mjs.map
