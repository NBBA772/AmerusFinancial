...
import { defineComponent, withCtx, createVNode, useSSRContext } from 'file:///Users/amerusfinancial/Desktop/projects/Amerus/app/node_modules/vue/index.mjs';
...
import _sfc_main$2 from './PipelineHeader-_KSK-ne6.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PatternSection, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-32 flex justify-center"${_scopeId}><div class="flex m-5"${_scopeId}><h1 class="py-9 text-center text-5xl font-extrabold text-gray-900 dark:text-gray-400 ml-4"${_scopeId}> Dashboard </h1></div></div><div class="md:flex min-h-full"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`<div class="md:w-1/3 z-1 flex justify-right relative"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "h-32 flex justify-center" }, [
                createVNode("div", { class: "flex m-5" }, [
                  createVNode("h1", { class: "py-9 text-center text-5xl font-extrabold text-gray-900 dark:text-gray-400 ml-4" }, " Dashboard ")
                ])
              ]),
              createVNode("div", { class: "md:flex min-h-full" }, [
                createVNode(_sfc_main$1),
                createVNode("div", { class: "md:w-1/3 z-1 flex justify-right relative" }, [
...
//# sourceMappingURL=index-C78_NI3X.mjs.map
