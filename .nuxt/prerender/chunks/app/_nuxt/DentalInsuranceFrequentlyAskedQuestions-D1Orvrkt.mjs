...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/DentalInsurancePage/DentalInsuranceFrequentlyAskedQuestions.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const DentalInsuranceFrequentlyAskedQuestions = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { DentalInsuranceFrequentlyAskedQuestions as default };
//# sourceMappingURL=DentalInsuranceFrequentlyAskedQuestions-D1Orvrkt.mjs.map
