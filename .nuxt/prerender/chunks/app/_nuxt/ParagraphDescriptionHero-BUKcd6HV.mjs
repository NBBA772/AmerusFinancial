...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<p${ssrRenderAttrs(mergeProps({ class: "mb-8 text-lg font-normal text-slate-900 dark:text-slate-400 lg:text-xl" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/elements/html/ParagraphDescriptionHero.vue");
...
//# sourceMappingURL=ParagraphDescriptionHero-BUKcd6HV.mjs.map
