...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<p${ssrRenderAttrs(mergeProps({ class: "mb-4 text-base font-normal text-gray-500 dark:text-gray-400" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/elements/html/ListItemParagraph.vue");
...
//# sourceMappingURL=ListItemParagraph-Cgavl4y4.mjs.map
