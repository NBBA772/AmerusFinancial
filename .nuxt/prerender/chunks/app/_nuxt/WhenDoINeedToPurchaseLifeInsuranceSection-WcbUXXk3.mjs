...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      IntroText: {
        Heading: "When do I need to purchase Life Insurance",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/LifeInsurancePage/WhenDoINeedToPurchaseLifeInsuranceSection.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const WhenDoINeedToPurchaseLifeInsuranceSection = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { WhenDoINeedToPurchaseLifeInsuranceSection as default };
//# sourceMappingURL=WhenDoINeedToPurchaseLifeInsuranceSection-WcbUXXk3.mjs.map
