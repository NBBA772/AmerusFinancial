...
import _sfc_main$2 from './QuestionBoard-fp4swFys.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PatternSection, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-32 flex justify-center"${_scopeId}><div class="flex m-5"${_scopeId}><h1 class="py-9 text-center text-5xl font-extrabold text-gray-900 dark:text-gray-400 ml-4"${_scopeId}> Search Questions </h1></div></div><div class="md:flex min-h-full"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "h-32 flex justify-center" }, [
                createVNode("div", { class: "flex m-5" }, [
                  createVNode("h1", { class: "py-9 text-center text-5xl font-extrabold text-gray-900 dark:text-gray-400 ml-4" }, " Search Questions ")
                ])
              ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dashboard/search.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=search-B-91gUzv.mjs.map
