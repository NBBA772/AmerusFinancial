...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/elements/html/HeadlineThree.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const HeadlineThree = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { HeadlineThree as default };
//# sourceMappingURL=HeadlineThree-DYNlYRkM.mjs.map
