...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/MedicarePage/MedicareInsuranceFrequentlyAskedQuestions.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const MedicareInsuranceFrequentlyAskedQuestions = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { MedicareInsuranceFrequentlyAskedQuestions as default };
//# sourceMappingURL=MedicareInsuranceFrequentlyAskedQuestions-Bozc6WRl.mjs.map
