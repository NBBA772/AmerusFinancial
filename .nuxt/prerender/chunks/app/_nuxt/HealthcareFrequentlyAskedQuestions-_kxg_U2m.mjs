...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/IndividualAndFamilyInsurancePage/HealthcareFrequentlyAskedQuestions.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const HealthcareFrequentlyAskedQuestions = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { HealthcareFrequentlyAskedQuestions as default };
//# sourceMappingURL=HealthcareFrequentlyAskedQuestions-_kxg_U2m.mjs.map
