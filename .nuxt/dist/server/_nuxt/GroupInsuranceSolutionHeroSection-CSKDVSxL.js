...
const _sfc_main = {
  ...
  data() {
    return {
      IntroText: {
        Heading: "Business Health Insurance-No Obligation Quote!",
        Description: "For 20 years, Amerus Financial delivers tailored insurance solutions, staying updated on trends. Streamlined process, tailored plans, top-rated carriers, trusted nationwide."
      }
    };
  }
};
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_GridTwoColumns, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div data-v-0340f737${_scopeId2}><div class="video-container" data-v-0340f737${_scopeId2}><iframe class="full-width-height" src="https://www.youtube.com/embed/pJLJhErFHqs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-v-0340f737${_scopeId2}></iframe></div></div><div class="p-4" data-v-0340f737${_scopeId2}>`);
                ...
                createVNode("div", null, [
                  createVNode("div", { class: "video-container" }, [
                    createVNode("iframe", {
                      ...
                      src: "https://www.youtube.com/embed/pJLJhErFHqs",
                      frameborder: "0",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/GroupHealthPage/GroupInsuranceSolutionHeroSection.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const GroupInsuranceSolutionHeroSection = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-0340f737"]]);
export {
  GroupInsuranceSolutionHeroSection as default
};
//# sourceMappingURL=GroupInsuranceSolutionHeroSection-CSKDVSxL.js.map
