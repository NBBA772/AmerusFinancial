...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex items-center p-6 pt-0 mt-auto"><a${ssrRenderAttr("href", _ctx.link)} class="justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[#30BCFE] text-white hover:bg-[#30BCFE]/80 h-10 px-4 py-2 w-full flex items-center gap-2">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: _ctx.icon,
        class: "h-4 w-4 mr-2"
      }, null, _parent));
      _push(`<span>View Guide</span></a></div></div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/resources/ResourceCard.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=ResourceCard-Do2j0t8n.js.map
