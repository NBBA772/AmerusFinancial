<template>
  <PatternSection>
    ...
    <div class="container mx-auto px-4 py-12">
        <Breadcrumbs
            currentPageTitle="Retirement Planning Checklist"
...
const pageTitle = 'Retirement Planning Checklist — 50+ Key Steps for a Secure Future'
...
useSchemaOrg([
  {
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Retirement Planning Checklist', item: pageUrl }
      ]
    }
  }
])
