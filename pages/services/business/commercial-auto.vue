...
const pageUrl = 'https://www.amerusfinancial.com/services/business/commercial-auto'
const pageTitle = 'Commercial Auto Insurance — Amerus'
const pageDescription = 'Comprehensive commercial auto insurance for business vehicles, fleets, and company cars. Protect your business with competitive rates from Amerus.'
