...
You may feel that purchasing health insurance is prohibitively expensive, based on your income. The federal government does provide some subsidies to help lower income individuals afford coverage. Whether you qualify for a grant will depend on many factors. If you or a loved one are approaching Medicare age, see our [Medicare Guide](/resources/medicare-guide/) for enrollment windows, parts, and coverage basics.
...
When you fill out the application, you’ll be using your modified adjusted gross income. Your adjusted gross income is the total amount of money you made last year, minus certain items. If you want to model how income and coverage affect your long‑term finances, try our [Retirement Calculator](/retirement/).

### List your household dependents and their income.

Now that you've got an income number, go to [www.healthcare.gov](https://www.healthcare.gov) and shop around for a plan you like. Depending on which method you select and what information you put in, the site will tell you whether you qualify for subsidies.
...
Before the affordable care act, insurance companies could adjust your premium rated based on things like your health status, medical history, gender, and the industry in which you worked. All that changed with the ACA. Today insurance premiums can only vary based on your age, whether you use tobacco products, your family size, and where you live. Also consider our [Retirement Planning Checklist](/resources/retirement-planning-checklist/) to make sure you’ve covered key financial and retirement planning items.
