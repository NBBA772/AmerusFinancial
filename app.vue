...
useHead({
  ...
  script: [
    ...
    },
    {
      ...
      "data-uuid": "d9ce0fbb-2201-4f35-943d-e7d1ad7e8913",
      src: "data:text/javascript;base64,",
      "data-nowprocket": "",
      "data-nitro-exclude": ""
    }
  ]
...
useSchemaOrg([
  defineLocalBusiness({
    ...
    '@id': 'https://www.amerusfinancial.com/#localbusiness',
    parentOrganization: { '@id': 'https://www.amerusfinancial.com/#identity' },
