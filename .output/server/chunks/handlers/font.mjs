import { d as defineEventHandler, k as parseURL, l as useOgImageRuntimeConfig, f as getQuery, c as createError, m as proxyRequest, i as sendRedirect } from '../nitro/node-server.mjs';
import { n as normaliseFontInput } from '../pure.mjs';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
