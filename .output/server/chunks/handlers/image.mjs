globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { L as hash, u as useRuntimeConfig, O as toRouteMatcher, P as createRouter, Q as withoutTrailingSlash, n as defu, R as withoutBase, S as defineDriver, T as createStorage, l as useOgImageRuntimeConfig, k as parseURL, c as createError, f as getQuery, D as withQuery, I as useNitroApp, U as withoutLeadingSlash, V as normalizeKey, W as prefixStorage, X as withTrailingSlash, Y as useStorage, Z as handleCacheHeaders, _ as setHeaders, $ as setHeader, d as defineEventHandler, a0 as H3Error } from '../nitro/node-server.mjs';
import { LRUCache } from 'lru-cache';
import { s as separateProps, n as normaliseFontInput } from '../pure.mjs';
import { renderSSRHead } from '@unhead/ssr';
import { a as createHeadCore } from '../app/server.mjs';
...
async function useSatoriRenderer() {
  satoriRendererInstance.instance = satoriRendererInstance.instance || await import('../renderer2.mjs').then((m) => m.default);
  return satoriRendererInstance.instance;
}
async function useChromiumRenderer() {
  chromiumRendererInstance.instance = chromiumRendererInstance.instance || await import('../renderer.mjs').then((m) => m.default);
